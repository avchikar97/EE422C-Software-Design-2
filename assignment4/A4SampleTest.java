...
public class A4SampleTest {
	...
	/*
	 * 4. KillCritters Test: killCritters Test for make critter and stats, and step Creates large number of make critters and compare stats after 500 steps Expects all Critters to be dead
	 */
	 ...
	 * 6. ParseErrors
	 * 
	 * Test: ParseErrors Test for errors within valid inputs Expects errors to be printed
	 */
